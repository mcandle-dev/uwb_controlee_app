...
> **버전: v0.3 (Draft)** · 개정일 2026-08-11 · **마스터 위치: `uwb-console-kotlin/docs/oob/`** (사본: `uwb_controlee_app/docs/oob/`)
...
> **미결 (구현 전 사람 확정 필요):** 병행 송출이 과하면 "모드 3 은 폰 주소 수동 입력" 으로 단순화할 수 있다.
> 병행안은 광고 2종이 동시에 뜨는 만큼 전력·스캔 혼선 리스크가 있다. 초안은 병행안을 기본으로 한다.
...
### 모드 3 (콘솔 ADVERTISE ↔ 폰 SCANNER) — Draft
